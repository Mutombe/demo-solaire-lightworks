...
export default function About() {
  return (
    <PageTransition>
      ...
      {/* Magazine opening */}
      <section className="bg-cream-50 pt-14 pb-20 lg:pt-20 lg:pb-24 relative">
        <div className="grain" />
        <div className="relative max-w-[1400px] mx-auto px-5 lg:px-10">
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-end">
            <div className="lg:col-span-8">
              <p className="font-accent text-2xl text-solaire-600">{story.eyebrow}</p>
              <h1 className="font-display text-5xl sm:text-6xl lg:text-8xl text-charcoal-900 leading-[0.98] text-balance mt-2">
            ...
            <div className="lg:col-span-4 flex lg:justify-end">
              <dl className="grid grid-cols-3 gap-6 lg:w-full max-w-sm">
                {story.stats.map((s) => (
                  <div key={s.label}>
      ...
      <section className="bg-cream-50 pb-20">
        <div className="max-w-[1400px] mx-auto px-5 lg:px-10 space-y-20 lg:space-y-28">
          {story.paragraphs.map((p, i) => {
            ...
            return (
              ...
              >
                <SectionReveal
                  className={`lg:col-span-6 ${left ? 'lg:order-1' : 'lg:order-2'}`}
                >
                ...
                <SectionReveal
                  className={`lg:col-span-6 ${left ? 'lg:order-2' : 'lg:order-1'}`}
                  delay={120}
                >
                  <p className="font-accent text-xl text-solaire-600 mb-3">
                    chapter 0{i + 1}
                  </p>
                  <p className="font-display text-2xl lg:text-3xl text-charcoal-800 leading-snug text-pretty max-w-xl">
                    {p}
                  </p>
                </SectionReveal>
              </div>
      ...
      <section className="relative">
        <div className="relative aspect-[16/9] max-h-[640px] w-full overflow-hidden bg-charcoal-900">
          <img
          ...
          <div className="relative h-full flex items-center justify-center px-6">
            <blockquote className="max-w-4xl text-center">
              <p className="font-display italic text-cream-50 text-3xl sm:text-4xl lg:text-6xl leading-[1.1] text-balance">
                "Light should feel like hospitality — warm, easy, generous. Not a
                cable management problem."
              </p>
              <footer className="mt-8 text-cream-200/80 text-xs tracking-[0.22em] uppercase">
            ...
            {values.map((v, i) => {
              ...
              return (
                <SectionReveal key={v.title} delay={i * 80}>
                  <div className="h-full bg-cream-50 border border-cream-300 p-8 lg:p-10 flex gap-5">
