...
function FAQItem({ q, a, open, onToggle }) {
  return (
    <div className="border-b border-cream-300">
      <button
        onClick={onToggle}
        className="w-full flex items-center justify-between gap-6 text-left py-5 lg:py-6 group"
      >
        <span className="font-display text-lg lg:text-xl text-charcoal-900 group-hover:text-solaire-600 transition-colors">
          {q}
        </span>
        <span className="shrink-0 h-8 w-8 border border-charcoal-300 flex items-center justify-center text-charcoal-700">
          {open ? <Minus size={14} /> : <Plus size={14} />}
        </span>
      </button>
      <div
        className={`overflow-hidden transition-[max-height,opacity,margin] duration-500 ease-out ${
          open ? 'max-h-96 opacity-100 mb-6' : 'max-h-0 opacity-0 mb-0'
        }`}
      >
        <p className="text-charcoal-600 leading-relaxed text-[15px] pr-12">
          {a}
        </p>
      </div>
    </div>
...
export default function Contact() {
  ...
  return (
    <PageTransition>
      ...
      <section className="bg-cream-50 pt-12 pb-10 lg:pt-16 lg:pb-12 relative">
        <div className="grain" />
        <div className="relative max-w-[1400px] mx-auto px-5 lg:px-10">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-5 text-charcoal-500 text-base lg:text-lg max-w-xl">
        ...
        <div className="max-w-[1400px] mx-auto px-5 lg:px-10">
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <SectionReveal className="lg:col-span-2">
              <div className="bg-charcoal-900 text-cream-50 p-8 lg:p-10 relative overflow-hidden">
                <div className="grain" />
                <div className="relative space-y-8">
                  <div>
                    <p className="font-accent text-2xl text-glow-400">
                      come say hello
                    </p>
                    <h2 className="font-display text-3xl lg:text-4xl mt-1">
                      The studio & more.
                    </h2>
                  </div>
              ...
              <div className="mt-6 aspect-[4/3] overflow-hidden border border-cream-300">
                <iframe
            ...
            <SectionReveal className="lg:col-span-3" delay={120}>
              <form
                ...
                className="bg-cream-100 border border-cream-300 p-8 lg:p-12 relative overflow-hidden"
              >
                <div className="grain" />
                <div className="relative">
                  ...
                  <h2 className="font-display text-3xl lg:text-4xl text-charcoal-900 mt-1">
                    Send us a note.
                  </h2>
                  ...
                  <div className="mt-8 grid sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-cream-50 border border-cream-300 px-4 py-3 text-sm focus:border-solaire-500 outline-none"
                        placeholder="Tariro"
                      />
                    </div>
                    <div>
                  ...
                  <div className="mt-5">
                    ...
                    <textarea
                      ...
                      className="w-full bg-cream-50 border border-cream-300 px-4 py-3 text-sm focus:border-solaire-500 outline-none resize-none"
                  ...
                  <div className="mt-6">
                    ...
                    <div className="inline-flex border border-cream-300 bg-cream-50 p-1">
                      <button
                        type="button"
                        onClick={() => setChannel('whatsapp')}
                        className={`px-5 py-2.5 text-xs tracking-[0.14em] uppercase transition-colors inline-flex items-center gap-2 ${
                          channel === 'whatsapp'
                  ...
                  <button
                    type="submit"
                    className={`mt-8 w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 text-sm tracking-[0.14em] uppercase transition-all duration-300 ${
                      channel === 'whatsapp'
          ...
          {/* FAQ */}
          <div id="faq" className="mt-24 lg:mt-32 grid lg:grid-cols-12 gap-10">
            <div className="lg:col-span-4">
              <p className="font-accent text-2xl text-solaire-600">
                before you ask
              </p>
              <h2 className="font-display text-4xl lg:text-5xl text-charcoal-900 leading-[1.05] mt-1 text-balance">
                Frequently asked.
              </h2>
              <p className="mt-5 text-charcoal-500 text-sm leading-relaxed max-w-xs">
